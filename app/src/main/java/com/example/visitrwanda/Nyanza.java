...
public class Nyanza extends AppCompatActivity {
    EditText Name1,email1,date,organization,phone1,editTextTime;
    Button Submit;
    TextView textView5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("Nyanza");
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Nyanza.this, "Data saved", Toast.LENGTH_SHORT).show();
                Toast.makeText(Nyanza.this, "THANK YOU FOR BOOKING", Toast.LENGTH_SHORT).show();
            }
        });
